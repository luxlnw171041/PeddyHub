...
class Pet extends Model
{
    ...
    */
     ...
     * @var array
     */
    protected $fillable = ['user_id', 'name', 'birth', 'photo', 'gender', 'size', 'age' ,'pet_category_id','sub_category','photo_2','photo_3','certificate','certificate_2','certificate_3','species'];
