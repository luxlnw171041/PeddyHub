            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-6 faq form-group {{ $errors->has('real_name') ? 'has-error' : ''}}">
                        <input style="border-radius: 25px 0px 25px 25px ;" class="form-control" type="text" id="real_name" value="{{ $real_name }}"  placeholder="ชื่อ-นามสกุล">
                        {!! $errors->first('real_name', '<p class="help-block">:message</p>') !!}
                    </div>
                    <div class="col-6 faq form-group {{ $errors->has('phone_user') ? 'has-error' : ''}}">
                        <input style="border-radius: 25px 0px 25px 25px ;" class="form-control" name="phone_user" type="text" id="phone_user" value="{{ $phone_user }}" pattern="[0-9]{10}"placeholder="หมายเลขโทรศัพท์">
