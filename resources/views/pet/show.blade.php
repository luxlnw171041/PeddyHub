                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr><th> User Id </th><td> {{ $pet->user_id }} </td></tr><tr><th> Name </th><td> {{ $pet->name }} </td></tr><tr><th> Birth </th><td> {{ $pet->birth }} </td></tr><tr><th> Photo </th><td> {{ $pet->photo }} </td></tr><tr><th> Gender </th><td> {{ $pet->gender }} </td></tr><tr><th> Size </th><td> {{ $pet->size }} </td></tr><tr><th> Age </th><td> {{ $pet->age }} </td></tr>
                                </tbody>
                            </table>
                        </div>
