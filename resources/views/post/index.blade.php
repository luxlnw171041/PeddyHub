                                                ...
                                                @foreach($comment as $data)
                                                    @if(($data->post_id  ==  $item->id))
                                                        <div class="col-2 text-center" style="padding:0px;margin-top:10px;">
                                                            @if(!empty($data->user->profile->photo))
                                                                <img style="border-radius: 50%;object-fit:cover; width:50px;height:50px;"  src="{{ url('storage')}}/{{ $data->user->profile->photo }}" alt="image of client" title="client" class="img-fluid customer">
                                                            @elseif(($data->user->profile->photo  ==  NULL))
                                                            ...
                                                            <div class="col-9" style="padding:0px">
                                                                <p style="margin-bottom:-25px;">{{$data->user->profile->name}}</p> 
                                                                <div class="card">
                                                                    <div class="card-body">
                                                                        {{$data->content}}
                                                                    </div>
