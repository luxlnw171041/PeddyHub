                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <thead>
                                    <tr>
                                        <th>#</th><th>User Id</th><th>Name</th><th>Photo</th><th>Phone</th><th>Birth</th><th>Sex</th><th>Type</th><th>Language</th><th>Actions</th>
                                    </tr>
                                </thead>
                                <tbody>
                                @foreach($profile as $item)
                                    <tr>
                                        ...
                                        <td>{{ $item->user_id }}</td><td>{{ $item->name }}</td><td>{{ $item->photo }}</td><td>{{ $item->phone }}</td><td>{{ $item->birth }}</td><td>{{ $item->sex }}</td><td>{{ $item->type }}</td><td>{{ $item->language }}</td>
                                        <td>
