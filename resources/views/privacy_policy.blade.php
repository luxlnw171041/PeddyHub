                        ...
                        <div class="text">
                            <ul> <br>
                                ...
                                <li><i class="orange fas fa-paw pr-2"></i> <b> 4.ข้อมูลส่วนบุคคลที่บริษัทจัดเก็บ</b></li>
                                    ...
                                    <li style="font-size: 16px; text-indent:30px;">4.2 ข้อมูลที่ผู้เข้าใช้บริการได้ลงทะเบียนสมัครสมาชิก เช่น ชื่อ, นามสกุล, หมายเลขโทรศัพท์, ไปรษณีย์อิเล็กทรอนิกส์, การบันทึกเสียง, การบันทึกการสนทนาทางโทรศัพท์, รูปถ่าย, วันที่สมัครเข้าเป็นสมาชิก หรือเปลี่ยนแปลงแก้ไขข้อมูลสมาชิก รวมไปถึงรายละเอียดอื่นๆตามความจำเป็น โดยจัดเก็บเพื่อวัตถุประสงค์ในการยืนยันตัวบุคคลและป้องกันการปลอมแปลงตัวตน</li><br>
