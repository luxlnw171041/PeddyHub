...
<body>
    <div class="page-wrapper">
            ...
            <div class="header-upper">
                <div class="header-inner-container clearfix">
                    <div class="pull-left logo-outer">
                        <div class="logo"><a href="index.html"><img src="peddyhub/images/logo-2.png" alt="" title=""></a></div>
                    </div>
            ...
            <div class="sticky-header">
                <div class="auto-container clearfix">
                    ...
                    <div class="logo pull-left">
                        <a href="index.html" class="img-responsive"><img src="peddyhub/images/logo-small.png" alt=""
                                title=""></a>
                    </div>
                    <!--Right Col-->
                ...
                <div class="rev_slider fullwidthabanner" id="rev_slider_one" data-version="5.4.1">
                    <ul> <br>
                        <li data-description="Slide Description" data-easein="default" data-easeout="default"
                            ...
                            data-hideafterloop="5" data-hideslideonmobile="off" data-index="rs-1689"
                            data-masterspeed="default" data-param1="" data-param10="" data-param2="" data-param3=""
                            data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9=""
                            data-rotate="5" data-saveperformance="off" data-slotamount="default"
                            data-thumb="peddyhub/images/main-slider/image-3.jpg" data-title="Slide Title"
                            data-transition="parallaxvertical">
                            <img alt="" class="rev-slidebg" data-bgfit="cover" data-bgparallax="10"
                                data-bgposition="center center" data-bgrepeat="no-repeat" data-no-retina=""
                                src="peddyhub/images/main-slider/image-3.jpg">
                        ...
                        <li data-description="Slide Description" data-easein="default" data-easeout="default"
                            ...
                            <div class="tp-caption tp-resizeme" data-paddingbottom="[0,0,0,0]"
                                data-paddingleft="[0,0,0,0]" data-paddingright="[0,0,0,0]" data-paddingtop="[0,0,0,0]"
                    asd            data-responsive_offset="on" data-type="text" data-height="none"
                                data-width="['550','550','550','420']" data-whitespace="normal"
                                data-hoffset="['15','15','15','15']" data-voffset="['130','130','130','110']"
                                data-x="['left','left','left','left']" data-y="['middle','middle','middle','middle']"
                                data-textalign="['top','top','top','top']"
        ...
        <!--Mission Section-->
        <section class="mission-section" style="background-image:url(peddyhub/images/background/pattern-1.png)">
            <div class="auto-container">
                <div class="row clearfix">
                    <!--Image Column-->
                    <div class="image-column col-md-6 col-sm-12 col-xs-12">
                        <div class="image">
                            <img src="peddyhub/images/resource/image-3.jpg" alt="" />
                        </div>
                    </div>
                    <!--Image Column-->
                    <div class="content-column col-md-6 col-sm-12 col-xs-12">
                        <div class="inner-column">
                            ...
                            <div class="signature"><img src="peddyhub/images/resource/signature.png" alt="" /></div>
                ...
                <div class="row clearfix">
                    ...
                    <div class="groming-block col-md-4 col-sm-6 col-xs-12">
                        <div class="inner-box">
                            ...
                            <div class="icon-box">
                                <img src="peddyhub/images/icons/icon-1.png" alt="" />
                            </div>
                            <h3>Cats</h3>
                    ...
                    <div class="groming-block col-md-4 col-sm-6 col-xs-12">
                        <div class="inner-box">
                            ...
                            <div class="icon-box">
                                <img src="peddyhub/images/icons/icon-2.png" alt="" />
                            </div>
                            <h3>Rabbits</h3>
                            <div class="text">GROOMING & spa</div>
                        </div>
                    ...
                    <div class="groming-block col-md-4 col-sm-6 col-xs-12">
                        <div class="inner-box">
                            ...
                            <div class="icon-box">
                                <img src="peddyhub/images/icons/icon-3.png" alt="" />
                            </div>
                            <h3>Dogs</h3>
                            <div class="text">GROOMING & spa</div>
                        </div>
        ...
        <section class="services-section-three" style="background-image:url(peddyhub/images/background/pattern-2.png)">
            <div class="auto-container">
                <!--Sec Title Two-->
                <div class="sec-title-two centered">
                    <div class="title-icon">
                ...
                <div class="row clearfix">
                    ...
                    <div class="column col-md-4 col-sm-12 col-xs-12">
                        <div class="image">
                            <img src="peddyhub/images/resource/dog.png" alt="" />
                        </div>
                    </div>
                    <!--Column-->
        ...
        <!--Appointment Section-->
        <section class="appointment-section style-two" style="background-image:url(peddyhub/images/background/layer-2.png)">
            <div class="auto-container">
                <!--Sec Title-->
        ...
        <!--End Gallery Section-->
        <!--Pricing Section-->
        <section class="pricing-section" style="background-image:url(peddyhub/images/background/pattern-3.png)">
            <div class="auto-container">
                <!--Sec Title Two-->
                    ...
                    <div class="testimonial-block">
                        <div class="inner-box">
                            ...
                            <div class="author-image">
                                <img src="peddyhub/images/resource/author-1.jpg" alt="" />
                            </div>
        ...
        <!--Subscribe Style One-->
        <section class="subscribe-style-one" style="background-image:url(peddyhub/images/background/7.jpg)">
            <div class="auto-container">
                <div class="row clearfix">
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="footer-column col-md-7 col-sm-6 col-xs-12">
                                    <div class="footer-widget logo-widget">
                                        <div class="logo">
                                            <a href="index.html"><img src="peddyhub/images/footer-logo.png" alt="" /></a>
                                        </div>
                                    ...
                                    <div class="footer-widget posts-widget">
                                        ...
                                        <article class="widget-post">
                                            <figure class="post-thumb"><a href="blog-single.html"><img
                                                        src="peddyhub/images/resource/post-thumb-1.jpg" alt=""></a></figure>
                                        ...
                                        <article class="widget-post">
                                            <figure class="post-thumb"><a href="blog-single.html"><img
                                                        src="peddyhub/images/resource/post-thumb-2.jpg" alt=""></a></figure>
    ...
    <div class="color-palate">
        ...
        <div class="various-color clearfix">
            <div class="colors-list">
                ...
                <span class="palate green-color" data-theme-file="peddyhub/css/color-themes/green-theme.css"></span>
                <span class="palate blue-color" data-theme-file="peddyhub/css/color-themes/blue-theme.css"></span>
                <span class="palate orange-color" data-theme-file="peddyhub/css/color-themes/orange-theme.css"></span>
                <span class="palate purple-color" data-theme-file="peddyhub/css/color-themes/purple-theme.css"></span>
                <span class="palate teal-color" data-theme-file="peddyhub/css/color-themes/teal-theme.css"></span>
                <span class="palate brown-color" data-theme-file="peddyhub/css/color-themes/brown-theme.css"></span>
                <span class="palate redd-color" data-theme-file="peddyhub/css/color-themes/redd-color.css"></span>
            </div>
        </div>
