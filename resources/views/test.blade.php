...
<head>
    <meta charset="utf-8">
    <title>Pawrex Template | Gallery</title>
    <!-- Stylesheets -->
...
<body>
    <div class="page-wrapper">
            ...
            <div class="header-upper">
                <div class="auto-container clearfix">
                    <div class="pull-left logo-outer">
                        <div class="logo"><a href="index.html"><img src="peddyhub/images/logo.png" alt="" title=""></a></div>
                    </div>
                        ...
                        <div class="nav-outer clearfix">
                            ...
                            <div class="outer-box">
                                ...
                                <div class="search-box-outer">
                                    <div class="dropdown">
                                        <button class="search-box-btn" type="button" id="dropdownMenu3" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><span class="fa fa-search"></span></button>
            ...
            <div class="sticky-header">
                <div class="auto-container clearfix">
                    ...
                    <div class="logo pull-left">
                        <a href="index.html" class="img-responsive"><img src="peddyhub/images/logo-small.png" alt="" title=""></a>
                    </div>
                    <!--Right Col-->
        ...
        <!--End Main Header -->
        <!--Page Title-->
        <section class="page-title" style="background-image:url(peddyhub/images/background/7.jpg)">
            <div class="auto-container">
                <div class="clearfix">
                    <div class="pull-left">
                        <h1>Gallery</h1>
        ...
        <footer class="main-footer style-two">
            <div class="auto-container">
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="footer-column col-md-7 col-sm-6 col-xs-12">
                                    <div class="footer-widget logo-widget">
                                        <div class="logo">
                                            <a href="index.html"><img src="peddyhub/images/footer-logo-2.png" alt="" /></a>
                                        </div>
                                ...
                                <div class="footer-column col-md-6 col-sm-6 col-xs-12">
                                    <div class="footer-widget posts-widget">
                                        ...
                                        <article class="widget-post">
                                            <figure class="post-thumb"><a href="blog-single.html"><img src="peddyhub/images/resource/post-thumb-1.jpg" alt=""></a></figure>
                                            <div class="text"><a href="blog-single.html">We have best Pet Grooming Services</a></div>
                                            <div class="post-info">Feb 15, 2021</div>
                                        </article>
                                        <!--Widget Post-->
                                        <article class="widget-post">
                                            <figure class="post-thumb"><a href="blog-single.html"><img src="peddyhub/images/resource/post-thumb-2.jpg" alt=""></a></figure>
                ...
                <div class="footer-bottom">
                    <div class="copyright">Copyrights 2021 <span>PAWREX Grooming Services</span> • All Rights Reserved.</div>
                </div>
            </div>
        </footer>
        <!--End Main Footer-->
    ...
    <script src="{{ asset('peddyhub/js/map-script.js') }}"></script>
</body>
