  ...
  position: relative;
        ...
        <section class="service">
            <div class="container">
                <div class="heading text-center">
                    ...
                    <h4 class="wow fadeInDown" style="visibility: visible;">Pet friendly places near me</h4>
                </div>
                <div class="row">
    ...
    <script>
        ...
        function initMap_location_by_T(input_province , input_amphoe , input_tambon) { 
            ...
            fetch("{{ url('/') }}/api/search_location_by_T_petland/" + input_province + "/" + input_amphoe + "/" + input_tambon)
            ...
            fetch("{{ url('/') }}/api/search_location_by_T_recommend_petland/" + input_province + "/" + input_amphoe + "/" + input_tambon )
                .then(response => response.json())
                .then(result => {
                    // console.log(result);
                    if (result.length === 0) {
        ...
        function search_my_location()
        {
            ...
            fetch("{{ url('/') }}/api/search_my_location_recommend_petland/" + latlng + "/" + distance)
                .then(response => response.json())
                .then(result => {
                    // console.log(result);
                    if (result.length === 0) {
            ...
            fetch("{{ url('/') }}/api/search_my_location_petland/" + latlng + "/" + distance)
                .then(response => response.json())
                .then(result => {
                    // console.log(result);
